...
write.csv(up, "/home/clodagh/MASTERS PROJECT/RNA_SEQ/TAN_upreg.csv")
```
...
write.csv(down, "/home/clodagh/MASTERS PROJECT/RNA_SEQ/TAN_downreg.csv")
```
...
ha_col = HeatmapAnnotation(df = ann,
                           col = list(Cell_Type = c("TAN" =  "#FF7F50",
                                                    "TASC" = "#369aa1")),
...
annotation_for_heatmap <- 
  data.frame(Tissue = samples$Condition)

row.names(annotation_for_heatmap) <- rownames(samples)
...
hm1 <- Heatmap(mat,
              col= colorRampPalette(rev(brewer.pal(n = 10, name =
"RdYlBu")))(100),
