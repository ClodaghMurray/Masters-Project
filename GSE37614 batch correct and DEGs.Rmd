...
fit <- limma::lmFit(rm_batch, design, weights = aw)
...
annotation= annot_col, border_color=NA, fontsize = 10, scale="row",
     fontsize_row = 10, height=20, main = "GSE37614 DEGS overall (|logFC| > 0.5 & adj.p.val < 0.05) ")
```
...
"RdYlBu")))(100),cluster_cols =  F, cluster_rows = T, show_rownames=F, show_colnames = F,
annotation= annot_col, border_color=NA, fontsize = 10, scale="row",
     fontsize_row = 10, height=20, main = "HER2 vs ER+ |logFC| > 0.5 & adj.p.val < 0.05")
...
"RdYlBu")))(100),cluster_cols =  F, cluster_rows = T, show_rownames=F, show_colnames = F,
annotation= annot_col, border_color=NA, fontsize = 10, scale="row",
     fontsize_row = 10, height=20, main = "HER2 vs TNBC (logFC > 0.5 & adj.p.val < 0.05) ")
...
venn.diagram(x = list(rownames(sig_HER_ER),
            ...
            hyper.test = T,
            total.population = nrow(rm_batch),
            lower.tail = F,
             margin = 0.15 )
...
annotation= annot_col, border_color=NA, fontsize = 10, scale="row",
     fontsize_row = 10, height=20, main = "214 overlapping DEGs")
```
