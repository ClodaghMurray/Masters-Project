...
heatmap.2(cor(log2(qnorm))^2, trace="none", scale="none", margins=c(9,9) )
dists <- as.matrix(dist(t(log2(qnorm)), method = "manhattan"))

rownames(dists) <- colnames(qnorm)
hmcol <- colorRampPalette(RColorBrewer::brewer.pal(9, "YlOrRd"))(255)
colnames(dists) <- NULL
diag(dists) <- NA

ann_colors <- list(
  subtype= c("resistent" = "chartreuse4", "sensitve" = "burlywood3"))
...
pheatmap(dists, col = (hmcol),
         ...
         main = "GSE108565Clustering heatmap normalized samples")
```
